...
- `adapters/tailwind3/theme.css` — Tailwind 3 CSS entrypoint for this brand.
- `adapters/tailwind3/tailwind.extend.ts` — Tailwind 3 theme extension adapter.
- `adapters/tailwind4/index.css` — Tailwind 4 CSS entrypoint for this brand.
- `adapters/tailwind4/shadcn.css` — Tailwind 4 shadcn-style theme adapter.
