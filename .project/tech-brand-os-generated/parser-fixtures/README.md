...
These fixtures are derived from `tech-blog-rounded-main` and are intended to validate how a parser splits classes into structural, semantic, decorative, and unknown buckets.
