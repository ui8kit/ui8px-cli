...
- `cms.md` — Support safe content operations with a branded but practical interface.
- `dashboard.md` — Make data, anomalies, and actions easy to scan without losing brand coherence.
- `docs.md` — Present technical documentation with clarity, navigability, and trustworthy brand tone.
